"""
===============================================================================
 HOSPITAL C - LOCAL MODEL TRAINING (5-FOLD CROSS-VALIDATION)
===============================================================================

This script trains the LSTM model using ONLY Hospital C's local data.
...
def load_hospital_data(hospital_dir):
    """
    Loads Hospital C's local dataset from .npy files.
    """
