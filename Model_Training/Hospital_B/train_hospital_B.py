"""
===============================================================================
 HOSPITAL B - LOCAL MODEL TRAINING (5-FOLD CROSS-VALIDATION)
===============================================================================

This script trains the LSTM model using ONLY Hospital B's local data.
...
def load_hospital_data(hospital_dir):
    """
    Loads Hospital B's local dataset from .npy files.
    """
